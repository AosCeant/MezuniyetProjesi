<>
  ...
  <title>Mezuniyet Projesi - 2024 </title>
      ...
      <div className="container px-5">
        <a className="navbar-brand" href="index.html">
          <img
            ...
            alt="Your Logo"
            className="mr-2"
            style={{ maxWidth: 350, maxHeight: 150 }}
          />
          <span className="fw-bolder text-primary">
            Meram Belediye Ara Birim Sayfası
          </span>
        </a>
        <button
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0 small fw-bolder">
            ...
            <li className="nav-item">
              <a className="nav-link" href="https://www.meram.bel.tr/ihaleler">
                İmar Sorgulama
              </a>
            </li>
            <li className="nav-item">
              <a
                className="nav-link"
                href="https://www.meram.bel.tr/e-belediye-hizmetleri"
              >
                E-Belediye
              </a>
            </li>
          ...
          <div className="col-xxl-5">
            <div className="text-center text-xxl-start">
              <div className="badge bg-gradient-primary-to-secondary text-white mb-4">
                <div className="text-uppercase">Mega · Yazılım · Akademi</div>
              </div>
              <div className="fs-3 fw-light text-muted">
                Tek Tıklama İle Her Şeye Erişin
              </div>
              <h1 className="display-3 fw-bolder mb-5">
                <span className="text-gradient d-inline">
                  Hızlıca İşlem Yapmanın Tek Adresi
                </span>
              </h1>
              <div className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                <a
                  className="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                  href="https://www.meram.bel.tr/e-imar"
                >
                  İmar Sorgulama
                </a>
                <a
            ...
            <div className="d-flex justify-content-center mt-5 mt-xxl-0">
              <div className="profile bg-gradient-primary-to-secondary">
                <img
                  ...
                  src="https://pbs.twimg.com/profile_images/1623688354129666053/PPIPwUGJ_400x400.jpg"
                  alt="..."
                />
            ...
            <div className="text-center my-5">
              ...
              <div className="d-flex justify-content-center fs-2 gap-4">
                <a
                  ...
                  href="https://www.instagram.com/mehmetyagizgulen?igsh=MWNzdGd6YWwwdDFm"
                >
                  <i className="bi bi-instagram" />
                </a>
                <a
                  className="text-gradient"
                  href="https://www.linkedin.com/in/mehmet-ya%C4%9F%C4%B1z-g%C3%BClen/"
                >
                  <i className="bi bi-linkedin" />
                </a>
                <a className="text-gradient" href="https://github.com/AosCeant">
    ...
    <div className="container px-5">
      <div className="row align-items-center justify-content-between flex-column flex-sm-row">
        <div className="col-auto">
          <div className="small m-0">Copyright © AosCeant 2024</div>
        </div>
        <div className="col-auto">
